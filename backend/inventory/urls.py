...
from .views import StockRecordListView, StockRecordDetailView, StockTodayView, StockLastBeforeView, WastageReportView

urlpatterns = [
    path('stock/', StockRecordListView.as_view(), name='stock-list'),
    path('stock/today/', StockTodayView.as_view(), name='stock-today'),
    path('stock/last-before/', StockLastBeforeView.as_view(), name='stock-last-before'),
