...
from .views import (
    ...
    StripeConnectSyncView,
    StripeConnectDisconnectView,
    StripeAdminResetView,
    StripeAdminStatusView,
...
urlpatterns = [
    ...
    path('connect/sync/', StripeConnectSyncView.as_view(), name='stripe-connect-sync'),
    path('connect/disconnect/', StripeConnectDisconnectView.as_view(), name='stripe-connect-disconnect'),
    path('admin/stripe/<slug:slug>/', StripeAdminStatusView.as_view(), name='stripe-admin-status'),
    path('admin/stripe/<slug:slug>/reset/', StripeAdminResetView.as_view(), name='stripe-admin-reset'),
